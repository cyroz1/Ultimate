...
if (Stop-UltimateArm64UnsupportedFeature -Feature 'The bundled graphics driver installers' -Reason 'This workflow downloads x64 vendor drivers and runs x64 installers. ARM64 Windows needs drivers from Windows Update or the device manufacturer.') {
